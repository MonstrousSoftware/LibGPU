...
public class TestLighting extends ApplicationAdapter {
    ...
    public void create() {
        ...
        ModelInstance instance = new ModelInstance(model, 0,-0.3f, 0);
        instances.add(instance);
       // model2 = new Model("models/sphere.gltf");
        model2 = new Model("models/waterbottle/WaterBottle.gltf");
        ModelInstance instance2 = new ModelInstance(model2, 0, 0.0f, 0);
